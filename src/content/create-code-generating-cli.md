...
I have a ready made CLI [here](https://github.com/BoyWithSilverWings/create-profile-card) that you can run with:
...
module.exports = {
  ...
  run: async toolbox => {
    ...
    /*
      ...
      https://github.com/BoyWithSilverWings/create-profile-card/blob/master/src/extensions/prompt-details.js
    */
...
[`bin/card.js`](https://github.com/BoyWithSilverWings/create-profile-card/blob/master/src/templates/bin/card.js.ejs) contains the javascript that will be suppled to the user. It uses boxen to draw a box and chalk to output text in colors for the console. It reads user details from `config.json` and creates console output.

You can find the complete application [here](https://github.com/BoyWithSilverWings/create-profile-card) for reference.
