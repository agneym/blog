...
tags: ['image alt tag', 'html', 'accessibility', 'images']
published: true
---

import calvinHobbes from './when-to-skip-alt/calvin-and-hobbes.gif';
...
![A Boy and his imaginary friend dancing](./when-to-skip-alt/calvin-and-hobbes.gif)
