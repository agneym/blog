...
For eg. You might know that unary `+` operator forces anything to convert to an integer. But the junior developer joining team tomorrow might now. So what is implicit for you just turned explicit for another person.
...
<JSLive
  ...
  snippets={{
    html: ``,
    css: ``,
    js: `const stringValue = "long string";
