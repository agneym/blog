...
import TwoVariables from "./value-vs-reference/two-variables.svg";
...
<svg height="20rem" style={{ margin: "4rem auto", display: "block"}} viewBox="0 0 451 175" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="1" y="1" width="119" height="44" fill="#FFFEFE" stroke="#0E5AEF" stroke-width="2"/>
<text x="35" y="26" fill="#000000">person</text>
<rect x="193" y="129" width="129" height="46" fill="#0E5AEF"/>
<rect x="322.5" y="129.5" width="128" height="45" fill="white" stroke="#0E5AEF"/>
<text x="238" y="157" fill="white">name</text>
<text x="368" y="157" fill="black">John</text>
<path d="M125.871 49.6985C125.512 49.2785 124.881 49.2287 124.461 49.5873C124.041 49.946 123.991 50.5772 124.35 50.9972L125.871 49.6985ZM189.933 127.808C190.291 128.228 190.922 128.278 191.342 127.919C191.762 127.561 191.812 126.93 191.454 126.509L189.933 127.808ZM124.35 50.9972L189.933 127.808L191.454 126.509L125.871 49.6985L124.35 50.9972Z" fill="#FF008A"/>
<circle cx="123.812" cy="48.8268" r="2.25" transform="rotate(49.5087 123.812 48.8268)" stroke="#FF008A" stroke-width="1.5"/>
<path d="M186.245 125.771C185.905 125.818 185.832 126.286 186.15 126.386L191.119 128.337C191.492 128.484 191.876 128.155 191.79 127.765L190.647 122.564C190.607 122.232 190.135 122.217 190.025 122.544C189.432 124.309 188.088 125.515 186.245 125.771Z" fill="#FF008A"/>
</svg>
...
![Developer and Person](./value-vs-reference/two-variables.svg)
...
![Everything pointing to one](./value-vs-reference/points.png)
